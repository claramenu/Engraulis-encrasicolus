...
data.ap = .8*365; units.ap = 'd';    label.ap = 'age at puberty';         bibkey.ap = 'PecqPeti2009';
  ...
  comment.ap = 'temperature: average sea surface temperature off West Portuguese coast, Angélico, pers. comm.)';
...
data.Wb = exp( 0.867 + 0.5 * data.Lb/10) * 1e-6; units.Wb = 'g';    label.Wb = 'dry weight at birth';    bibkey.Wb = 'CataFolk2010';
  comment.Wb = 'CataFolk2010: ln DW (\mug) = 0.867 + 0.5 SL (mm) - field data';
data.Wj = 0.0007 * data.Lj^4.2395;  units.Wj = 'g';    label.Wj = 'dry weight at metam';    bibkey.Wj = 'Pecq2008';
  comment.Wb = 'from Ifremer Juvesu 1999 survey, 3 - 4.4 cm SL fish average';
data.Wp = 0.0041 * data.Lp ^3.2099; units.Wp = 'g';    label.Wp = 'wet weight at puberty';  bibkey.Wp = 'Pecq2008';
  comment.Wp = 'From Ifremer PELGAS surveys (PecqPeti2009) - Total length (need checking, includes reprod buffer already)';
data.Wi = 0.0041 * data.Li ^3.2099; units.Wi = 'g';    label.Wi = 'ultimate wet weight';    bibkey.Wi = 'Pecq2008';
  comment.Wi = 'From Ifremer PELGAS surveys (PecqPeti2009) - Total length (need checking)';
...
%% Links
metaData.links.id_CoL = '2abe41c8ee39bb550534f328bf4717a3'; % Cat of Life
metaData.links.id_EoL = '223061'; % Ency of Life
...
metaData.links.id_fishbase = 'Engraulis-encrasicolus.html'; % fishbase
